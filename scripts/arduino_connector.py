...
class ArduinoBridge:
    ...
    def find_arduino(self):
        ...
        for p in ports:
            # Prefer known Arduino Leonardo VID/PID when available.
            try:
        ...
        if self.connection and self.connection.is_open:
            try:
                ...
                try:
                    ...
                    # Flush may not be supported/needed for some serial backends.
                    pass
    ...
    def read_line(self, timeout_s: float = 2.0) -> str | None:
        """Read a single \n-terminated line from the Arduino."""
    ...
    def handshake(self) -> bool:
        """PING/PONG health-check for the StealthHID firmware."""
